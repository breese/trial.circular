...
public:
    ...
    using super::end;
    // Make public
    using super::advance_front;
    using super::advance_back;
};
...
void run()
{
    advance_empty();
    advance_0();
    advance_back_front_1();
    advance_back_back_1();
    advance_front_front_1();
    advance_front_back_1();
    advance_back_n();
    advance_front_n();
