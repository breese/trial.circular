...
| `template <typename InputIterator>
 +
 constexpr{wj}footnote:constexpr11[] void push_back(value_type) noexcept(_see Remarks_)` | Inserts elements from iterator range at the end of the span.
 +
 +
 _Constraint:_ `value_type` must be _CopyAssignable_.
 +
 ...
 +
 _Remarks:_ `noexcept` if `value_type` is nothrow _CopyAssignable_.
| `constexpr{wj}footnote:constexpr11[] void pop_front() noexcept` | Erases element from the beginning of the span.
 +
 +
 ...
 +
 _Expects:_ `size() > 0`
| `constexpr{wj}footnote:constexpr11[] void pop_front(size_type count) noexcept` | Erases the specified number of elements from the beginning of the span.
 +
 +
...
| `constexpr{wj}footnote:constexpr11[] void pop_back() noexcept` | Erases element from the end of the span.
 +
 +
 The erased element in the underlying storage is not destroyed.
 +
 +
 _Expects:_ `size() > 0`
| `constexpr{wj}footnote:constexpr11[] void pop_back(size_type count) noexcept` | Erases the specified number of elements from the end of the span.
 +
 +
 The erased elements in the underlying storage are not destroyed.
 +
